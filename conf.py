...
htmlhelp_basename = 'phpmanagerarchive'
...
latex_documents = [
  (master_doc, 'phpmanagerarchive.tex', u'PHP Manager Archive',
   u'PHP Manager', 'manual'),
]
...
man_pages = [
    (master_doc, 'phpmanagerarchive', u'PHP Manager Archive',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'phpmanagerarchive', u'PHP Manager Archive',
   author, 'phpmanagerarchive', 'PHP Manager Archive',
...
if not on_rtd:
    edit_on_github_project = 'phpmanager/docs'
...
def setup(app):
    ...
    if not on_rtd:
        ...
        """
        app.add_javascript("https://www.googletagmanager.com/gtag/js?id=UA-1962620-24")
